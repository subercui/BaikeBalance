...
def build_stateful_rnn(in_dim, out_dim, h0_dim, h1_dim=None, layer_type=SimpleRNN, return_sequences=True):
    ...
    input_dim=in_dim, return_sequences=return_sequences,stateful=True,batch_input_shape=(1,10,in_dim)))  
...
def init(length,n_hiddens):
    ...
    MLPmodel.load_weights(parent_path+'/RNN_weights10REGU1.0.hdf5')
